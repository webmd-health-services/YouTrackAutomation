...
* Rename every file that has `YouTrackAutomation` in its name, replacing `YouTrackAutomation` with the module name.
* Replaces `YouTrackAutomation` in every file with the module name.
